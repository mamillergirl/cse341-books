...
router.post("/", auth.ensureAuth, validation.createAuthor, authorsController.createOne);
router.put("/:id", auth.ensureAuth,  validation.createAuthor, authorsController.updateOne);
